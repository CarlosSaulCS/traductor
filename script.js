...
let rateFactor = 1.04;  // multiply time to correct progressive drift (default +0.04)
...
let lineLeadSeconds = 0.44; // advance line transitions a bit more (doubled for faster paragraph jumps)
let autoSync = true;
